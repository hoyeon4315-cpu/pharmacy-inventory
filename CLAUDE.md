...
## 리팩토링 플랜
`.claude/plans/witty-wondering-clarke.md` 참조
`.claude/plans/jolly-marinating-meteor.md` - Cloudflare 배포 플랜

## 남은 작업
- REQ 7: 공급뉴스 공공데이터 API 연동 → **완료** (4종 API 연동, DATA_GO_KR_API_KEY 설정 완료)
  - `.claude/plans/news-openapi-upgrade.md` 참조
- REQ 8: 뉴스 원내/원외 매칭 → `.claude/plans/news-drug-matching.md` 참조
